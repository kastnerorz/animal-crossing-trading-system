        ...
        <b-collapse class="card" animation="slide" aria-id="contentIdForA11y3">
            ...
            <div class="card-content">
                <div class="content">
                    ...
                    <b-field label="岛上人数">
                      <b-numberinput v-model="myQuotation.participantCount" @input="updateMyQuotation" min="0" max="8" controls-position="compact"></b-numberinput>
                    </b-field>
                </div>
            </div>
        </b-collapse>
...
export default {
  ...
  methods: {
    ...
    async updateMyQuotation() {
      this.myQuotation = await this.$axios.$put(`/quotations/${this.myQuotation.id}`, {
